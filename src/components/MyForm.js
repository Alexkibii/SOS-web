...
const MyForm = (props) => {
  ...
  const registerurl = 'http://104.131.118.153:3000/subscribe';
  const flareurl =
 ...
 // the alert is displayed by default
  ...
  const [url, setUrl] = useState(
    'http://104.131.118.153:3000/kyc/subscriberinfo?msisdn=0114959286'
  );
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={12} sm={6}>
                            <FieldArray
                              ...
                              render={(arrayHelpers) => (
                                <div>
                                  {values.members[index].emails &&
                                  values.members[index].emails.length > 0 ? (
                                    values.members[index].emails.map(
                                      (mail, i) => (
                                        <div key={mail.i}>
                                          <InputField
                                            label="Email Address"
